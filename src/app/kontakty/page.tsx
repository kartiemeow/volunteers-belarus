...
const FAQ = [
  {
    ...
    a: "Всё бесплатно. Платформа и волонтёрство не берут платы, от вас нужно только ваше время и желание помочь.",
  },
  {
  ...
  },
  {
    ...
    a: "Организация может публиковать заявки до проверки. До подтверждения администратором её профиль отмечен как ожидающий проверки. Проверенный профиль получает отдельную отметку.",
  },
  {
