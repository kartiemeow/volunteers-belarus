    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-lg text-gray-600">
          Волонтёр или организация — оба проходят один и тот же путь от
          регистрации до отметки выполненной работы.
        </p>
      </div>
      ...
      <div className="mt-12 rounded-2xl bg-emerald-600 px-8 py-10 text-center text-white">
        ...
        <p className="mx-auto mt-2 max-w-xl text-emerald-50">
          Присоединяйтесь. Волонтёры найдут заявку, организации получат людей.
        </p>
